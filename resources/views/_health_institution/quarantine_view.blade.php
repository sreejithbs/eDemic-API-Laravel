...
@section('page_title', 'View Self Quarantine User Details | e-Demic')
@section('page_heading', 'View Self Quarantine User Details')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Self Quarantine User Location Logs</h4>
                    <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                    <div class="heading-elements">
                        <span class="badge">
                            <a href="{{ route('institution_quarantine.listQuarantine') }}" class="btn btn-sm btn-secondary">
