...
$(document).ready(function(){
	...
	$('#type-warning').on('click',function(){
		swal("Warning!", "Insufficient data for Report generation, please try again later.", "warning");
	});

	$('#type-warning2').on('click',function(){
		swal("Warning!", "Insufficient data for Report generation, please try again later.", "warning");
	});

	$('#logbook-warning').on('click',function(){
		swal("Warning!", "Insufficient data for Log Book generation, please try again later.", "warning");
	});

	$('#logbook-warning2').on('click',function(){
		swal("Warning!", "Insufficient data for Log Book generation, please try again later.", "warning");
	});

	$('#escaltion-warning').on('click',function(){
		swal("Warning!", "Insufficient Escalation data, Please try again later.", "warning");
	});

	$('#task-warning').on('click',function(){
		swal("Warning!", "Task Date is not due, please try again later.", "warning");
	});
